...
export const marketCurveModels = mysqlTable("market_curve_models", {
	...
	impressionCurveA: decimal("impression_curve_a", { precision: 15, scale: 6 }),
	impressionCurveB: decimal("impression_curve_b", { precision: 15, scale: 6 }),
	impressionCurveC: decimal("impression_curve_c", { precision: 15, scale: 6 }),
	impressionCurveR2: decimal("impression_curve_r2", { precision: 10, scale: 6 }),
	baseCTR: decimal("base_ctr", { precision: 10, scale: 6 }),
	positionBonus: decimal("position_bonus", { precision: 10, scale: 6 }),
	topSearchCTRBonus: decimal("top_search_ctr_bonus", { precision: 10, scale: 6 }),
	cvr: decimal({ precision: 10, scale: 6 }),
	aov: decimal({ precision: 15, scale: 2 }),
	conversionDelayDays: int("conversion_delay_days").default(7),
	cvrSource: mysqlEnum("cvr_source", ['historical', 'predicted', 'default']).default('historical'),
	...
	breakEvenCPC: decimal("break_even_cpc", { precision: 10, scale: 4 }),
	currentBid: decimal("current_bid", { precision: 10, scale: 4 }),
	bidGap: decimal("bid_gap", { precision: 10, scale: 4 }),
	bidGapPercent: decimal("bid_gap_percent", { precision: 10, scale: 4 }),
