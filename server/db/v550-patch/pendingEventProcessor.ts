...
import { keywords, pendingEvents } from '../../drizzle/schema';
import { sql } from 'drizzle-orm';

export function startPendingEventProcessor() {
...
export function stopPendingEventProcessor() {
  if (processorInterval) {
...
export function getPendingEventProcessorStatus() {
  return {
