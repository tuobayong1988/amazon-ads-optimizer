...
export async function getOptimizationTargetConfig(targetId: number): Promise<OptimizationTargetConfig | null> {
  ...
  return {
    ...
    daypartingMinBudgetPercent: parseFloat(String(target.daypartingMinBudgetPercent || '2')),
    daypartingMaxBudgetPercent: parseFloat(String(target.daypartingMaxBudgetPercent || '15')),
