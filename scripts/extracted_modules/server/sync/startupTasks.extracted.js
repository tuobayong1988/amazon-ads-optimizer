...
// Original module: server/sync/startupTasks.ts
// Lines: 500
...
var log214;
var init_startupTasks = __esm({
  "server/sync/startupTasks.ts"() {
    "use strict";
    init_connection();
    init_logger();
    init_distributedQueue();
    log214 = createModuleLogger("StartupTasks");
    __name(zombieCleanup, "zombieCleanup");
    __name(reconcile, "reconcile");
    __name(deepReconcile, "deepReconcile");
    __name(autoArchiveTasks, "autoArchiveTasks");
    __name(accountHealthManager, "accountHealthManager");
    __name(checkWeeklyReset, "checkWeeklyReset");
    __name(ensureAdAccountFields, "ensureAdAccountFields");
    __name(healthCheckAndCleanup, "healthCheckAndCleanup");
    __name(ensureTables, "ensureTables");
    __name(initStartupTasks, "initStartupTasks");
  }
});
