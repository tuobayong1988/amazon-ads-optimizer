...
// Original module: server/sync/syncSchedulerAdapter.ts
// Lines: 151

var syncSchedulerAdapter_exports = {};
__export(syncSchedulerAdapter_exports, {
  enqueueManualSync: () => enqueueManualSync,
  enqueueSyncTier: () => enqueueSyncTier,
  isRedisQueueEnabled: () => isRedisQueueEnabled
});
...
async function enqueueSyncTier(tier2) {
  const result = {
    success: false,
    totalAccounts: 0,
    enqueued: 0,
...
async function enqueueManualSync(accountId, tier2 = "full") {
...
var init_syncSchedulerAdapter = __esm({
  "server/sync/syncSchedulerAdapter.ts"() {
    ...
    log143 = createModuleLogger("SyncSchedulerAdapter");
    __name(isRedisQueueEnabled, "isRedisQueueEnabled");
    __name(enqueueSyncTier, "enqueueSyncTier");
    __name(enqueueManualSync, "enqueueManualSync");
    __name(tierToPriority, "tierToPriority");
