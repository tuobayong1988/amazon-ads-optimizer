...
// Original module: server/services/budgetRulesCoordinator.ts
// Lines: 183
...
var log39;
var init_budgetRulesCoordinator = __esm({
  "server/services/budgetRulesCoordinator.ts"() {
    ...
    init_drizzle_orm();
    init_logger();
    log39 = createModuleLogger("BudgetRulesCoordinator");
    __name(getPSTTimeInfo, "getPSTTimeInfo");
    __name(isScheduleRuleActive, "isScheduleRuleActive");
    __name(isPerformanceRulePotentiallyActive, "isPerformanceRulePotentiallyActive");
    __name(analyzeBudgetRules, "analyzeBudgetRules");
    __name(analyzeRulesFromDB, "analyzeRulesFromDB");
    __name(analyzeRulesFromAPI, "analyzeRulesFromAPI");
  }
});
