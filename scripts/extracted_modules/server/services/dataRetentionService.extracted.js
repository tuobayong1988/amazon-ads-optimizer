...
// Original module: server/services/dataRetentionService.ts
// Lines: 369

var dataRetentionService_exports = {};
__export(dataRetentionService_exports, {
  executeDataCleanup: () => executeDataCleanup,
...
var init_dataRetentionService = __esm({
  "server/services/dataRetentionService.ts"() {
    "use strict";
    init_db2();
    init_drizzle_orm();
    init_logger();
    import_v8 = __toESM(require("v8"));
    log65 = createModuleLogger("DataRetention");
    RETENTION_CONFIG = {
      /** amazon_deleted 实体保留天数 */
      deletedEntityRetentionDays: 30,
      /** 已完成优化任务保留天数 */
      completedTaskRetentionDays: 30,
      /** 出价日志保留天数 */
      biddingLogRetentionDays: 90,
      /** 同步冲突记录保留天数 */
      syncConflictRetentionDays: 30,
      /** 系统日志保留天数 */
      systemLogRetentionDays: 30,
      /** 同步变更记录保留天数 */
      syncChangeRecordRetentionDays: 30,
      /** 每批删除数量 */
      batchSize: 1e3,
      /** 批次间延迟（毫秒） */
      batchDelayMs: 500,
    ...
    __name(batchDelete, "batchDelete");
    __name(executeDataCleanup, "executeDataCleanup");
    __name(getRetentionStats, "getRetentionStats");
  }
});
