...
// Original module: server/_core/oauth.ts
// Lines: 1835
...
function registerOAuthRoutes(app) {
  app.get("/api/oauth/callback", async (req, res) => {
    ...
    try {
      ...
      log20.warn("[OAuth] Callback failed", error48);
...
var init_oauth = __esm({
  "server/_core/oauth.ts"() {
    ...
    init_cookies();
    init_sdk();
    log20 = createModuleLogger("OAuth");
    __name(getQueryParam, "getQueryParam");
    __name(registerOAuthRoutes, "registerOAuthRoutes");
  }
});
      ...
      function clone2(configObject) {
        ...
        convertBase = /* @__PURE__ */ (function() {
          ...
          return function(str, baseIn, baseOut, sign, callerIsToString) {
            ...
            xc = toBaseOut(str, baseIn, baseOut, callerIsToString ? (alphabet = ALPHABET2, decimal2) : (alphabet = decimal2, ALPHABET2));
            e = k = xc.length;
            for (; xc[--k] == 0; xc.pop()) ;
  ...
  "node_modules/json-bigint/lib/parse.js"(exports2, module2) {
    ...
    var json_parse = /* @__PURE__ */ __name(function(options) {
      ...
      var at, ch, escapee = {
        ...
        r: "\r",
        t: "	"
      }, text2, error48 = /* @__PURE__ */ __name(function(m) {
        throw {
          name: "SyntaxError",
          message: m,
          at,
        ...
        if (ch === '"') {
          ...
          while (next()) {
            if (ch === '"') {
              if (at - 1 > startAt) string5 += text2.substring(startAt, at - 1);
              next();
              return string5;
            }
            if (ch === "\\") {
      ...
      }, "word"), value, array2 = /* @__PURE__ */ __name(function() {
        var array3 = [];
        if (ch === "[") {
          next("[");
          white();
